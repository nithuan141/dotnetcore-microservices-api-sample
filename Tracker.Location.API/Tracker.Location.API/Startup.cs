...
using Tracker.Location.API.Middlewares;

namespace Tracker.Location.API
{
    /// <summary>
    ...
    public class Startup
    {
        ...
        /// Name of the API
        /// </summary>
        private const string API_NAME = "Location Tracker API";
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.ConfigureSwagger(API_NAME, "API for location tracking service.");
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILogger<Startup> logger)
        {
            if (env.IsDevelopment())
            {
                ...
                //Setting up  some initial data for dev test
